...
import '../../../plans/presentation/controller/plans_controller.dart';

Widget planDetails(BuildContext context) {
  final PlansController controller = PlansController.instance;
  return Container(
    height: Get.height,
    width: Get.width,
